...
class TabbedControlFilters:
    def __init__(self, parent, file_navigator):
        ...
        self.canvas1 = tk.Canvas(self.frame, bg="SlateGray4",bd=20,width=100, height=40)
        ...
        self.can2= tk.Canvas(self.frm2, background="azure4",bd=150)
        ...
        self.can6= tk.Canvas(self.frm6, background="cyan4",bd=15)
        ...
        self.can9= tk.Canvas(self.frame, background="thistle3",bd=150)
